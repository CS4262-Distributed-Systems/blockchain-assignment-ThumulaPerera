...
public final class AssetTransferTest {
    ...
    class DuplicateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            Asset asset = contract.DuplicateAsset(ctx, "asset1", "Thumula");

            assertThat(asset.getOwner()).isEqualTo("Thumula");
            assertThat(asset.getColor()).isEqualTo("blue");
            assertThat(asset.getSize()).isEqualTo(5);
            assertThat(asset.getAppraisedValue()).isEqualTo(300);
        }
